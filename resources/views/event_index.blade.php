                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- MODIFIKASI 3: Isi Kolom Poster (Pengecekan & Pemanggilan Symlink) --}}
                            <td class="text-center">
                                @if($event->poster)
                                    <img src="{{ asset('storage/' . $event->poster) }}" width="60" class="rounded shadow-sm border">
                                @else
                            ...
                            {{-- MODIFIKASI 4: Isi Kolom Aksi (Tombol Edit dan Hapus) --}}
                            <td class="text-center">
                        ...
                        @empty
                        <tr>
                            {{-- MODIFIKASI 5: Ubah colspan dari 5 menjadi 7 karena ada tambahan kolom --}}
